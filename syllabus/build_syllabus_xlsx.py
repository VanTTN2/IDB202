"""Build the IDB202 syllabus workbook from the university template.
...
Output: syllabus/IDB202_Syllabus.xlsx
...
OUTPUT = ROOT / "IDB202_Syllabus.xlsx"
...
def build_markdown(path=ROOT / "syllabus.md"):
    ...
    L = ["# IDB202 – Introduction to Databases: Course Syllabus", "",
         "> Generated by `syllabus/build_syllabus_xlsx.py` from the same data as "
         "[`IDB202_Syllabus.xlsx`](IDB202_Syllabus.xlsx). **Status: proposal for review by the syllabus council.**", "",
