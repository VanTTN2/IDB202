...
Course materials for **IDB202 – Introduction to Databases**, taught to talented-student (honors) classes of the Bachelor of Computer Science, AI and Data Science specialization (BCS_AD, K22A), in Year 1, Semester 1. The course is academic and research-oriented. All content is in English.

## Status

| Deliverable | Status |
|---|---|
| Syllabus (university template) – [`syllabus/IDB202_Syllabus.xlsx`](syllabus/IDB202_Syllabus.xlsx), with a Markdown view in [`syllabus/syllabus.md`](syllabus/syllabus.md) | **Proposal, awaiting council review** |
| Academic emphasis brief for the review council – [`docs/IDB202_Academic_Emphasis_Brief.docx`](docs/IDB202_Academic_Emphasis_Brief.docx) | Ready |
...
python syllabus/build_syllabus_xlsx.py      # -> syllabus/IDB202_Syllabus.xlsx and syllabus/syllabus.md

npm install docx
node docs/build_brief.js docs/IDB202_Academic_Emphasis_Brief.docx
```
