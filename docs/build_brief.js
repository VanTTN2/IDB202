...
children.push(
  ...
  gap(),
  H2("4.7 Preparing the CLO–PLO mapping"),
  P("The BCS_AD PLO list has not been received yet, so the mapping matrix in the syllabus is left blank. Most Computer Science PLO sets include the outcome areas below. This preliminary view is meant to speed up the final mapping, and will be replaced by the official PLO numbers."),
  table(
    ["Typical PLO area", "Likely CLOs", "Expected level"],
    [
      ["Mathematical and computing foundations", "CLO1, CLO3, CLO5", "I – R"],
      ["Problem analysis and solution design", "CLO2, CLO5, CLO6", "I – R"],
      ["Use of modern tools and techniques", "CLO4, CLO6", "I"],
      ["Research, critical and scientific thinking; lifelong learning", "CLO3, CLO5, CLO8", "I"],
      ["Written and oral communication", "CLO8", "I"],
      ["Teamwork", "CLO8 (Assignment 2 is a group project)", "I"],
    ],
    [3800, 3026, 2200],
  ),
  P("I = Introduce, R = Reinforce, M = Master. As a semester-1 course, IDB201 mostly introduces program outcomes. It reinforces them only where it builds on MAD102, which students take in the same semester."),
);
...
children.push(
  ...
  N("**CLO–PLO mapping:** the BCS_AD PLO list is needed to complete the mapping matrix in the syllabus template; a preliminary view is given in §4.7."),
